...
bus_nodeControlPanel.write("\n" + indent*3)
bus_nodeControlPanel.write("<Property Name=\"Size\">" + str(bus_nodeControlPanel_columns * 190) + ", " + ("365" if (bus_nodeControlPanel_index > 7) else str(100 * bus_nodeControlPanel_index)) + "</Property>")
bus_nodeControlPanel.write("\n" + indent*3)
...
bus_nodeControlPanel.write("\n" + indent*2)
bus_nodeControlPanel.write("<Property Name=\"Size\">" + str(bus_nodeControlPanel_columns * 190 + 10) + ",  " + ("405" if (bus_nodeControlPanel_index > 7) else str(100 * bus_nodeControlPanel_index + 40)) + "</Property>")
bus_nodeControlPanel.write("\n" + indent*1)
bus_nodeControlPanel.write("</Object>")
bus_nodeControlPanel.write("\n" + "</Panel>")
